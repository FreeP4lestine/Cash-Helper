...
Gui, Add, Button, % "xm+5 ym+20 gAdd HwndHCtrl w190 h60", % s198
...
CtlColors.Attach(HCtrl, "EAEAB5")
Gui, Font, s16
Gui, Add, Button, % "gDelete HwndHCtrl wp h60", % s191
ImageButton.Create(HCtrl, ButtonTheme2* )

Gui, Font, s14
Gui, Add, ListView, % "xm+421 ym+20 w" qw * 3 - 391 " h" A_ScreenHeight - 200 " vLV", % "|" s38 "|" s68 "|" s39
...
Gui, Add, Button, % "wp h30 HwndHCtrl gKridiOut", % s29
...
Gui, Add, Button, % "wp h30 HwndHCtrl gPayOut", % s186
